...
#define timestauh _p[1]
#define timestauh_columnindex 1
#define timestaum _p[2]
#define timestaum_columnindex 2
#define shifttaum _p[3]
#define shifttaum_columnindex 3
#define shifttauh _p[4]
#define shifttauh_columnindex 4
#define thegna _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nap /mnt/c/Users/analk/OneDrive/Desktop/2021-12-20-ModellingPaper/Fig2/Turi_et_al_2018_o/mechanisms/nap.mod\n");
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 55 in file nap.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/c/Users/analk/OneDrive/Desktop/2021-12-20-ModellingPaper/Fig2/Turi_et_al_2018_o/mechanisms/nap.mod";
static const char* nmodl_file_text = 
  "TITLE nap\n"
  "\n"
  "COMMENT\n"
