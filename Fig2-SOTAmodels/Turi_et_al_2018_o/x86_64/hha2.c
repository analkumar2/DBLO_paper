...
#define ar2 _p[0]
#define ar2_columnindex 0
#define W _p[1]
#define W_columnindex 1
#define gnabar _p[2]
#define gnabar_columnindex 2
#define gkbar _p[3]
#define gkbar_columnindex 3
#define gl _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "k_ion");
 	...
 	ivoc_help("help ?1 hha2 /mnt/c/Users/analk/OneDrive/Desktop/2021-12-20-ModellingPaper/Fig2/Turi_et_al_2018_o/mechanisms/hha2.mod\n");
...
double varss (  double _lv , double _li ) {
   double _lvarss;
 if ( _li  == 0.0 ) {
     _lvarss = 1.0 / ( 1.0 + exp ( ( _lv + 42.5 ) / ( - 3.0 ) ) ) ;
     }
   else if ( _li  == 1.0 ) {
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 73 in file hha2.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/c/Users/analk/OneDrive/Desktop/2021-12-20-ModellingPaper/Fig2/Turi_et_al_2018_o/mechanisms/hha2.mod";
static const char* nmodl_file_text = 
